...
<div class="col-span-2">
  <div class="p-3 rounded-lg bg-purple-500/10 border border-purple-400/30">
    ...
    <div class="text-xs opacity-80 space-y-2">
      ...
      <div>The Base Meshから3Dモデルをダウンロードしてシーンに入れてみよう！</div>
    </div>
  </div>
</div>
...
<a href="https://gemini.google.com/gem/1Vx0qjBjKQPfuBUIZuTiJe0ckR-wrqx97?usp=sharing" target="_blank" class="inline-block mt-2 px-3 py-1 bg-purple-500/20 rounded text-purple-300 hover:bg-purple-500/30">
  Gem を使ってみる →
</a>
