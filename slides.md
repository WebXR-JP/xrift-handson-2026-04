...
<div class="text-lg opacity-80 mt-1">
  プログラミングがはじめての方でも、90 分でこれができるようになります
</div>

<div class="mt-6 space-y-4 text-xl">

<div class="flex items-start gap-5 p-4 rounded-xl bg-purple-500/10 border border-purple-400/30">
  <div class="text-purple-300 font-bold text-3xl w-12 text-center shrink-0">1</div>
  <div>
    <div class="font-bold text-purple-300 text-2xl">XRift の開発環境を整える</div>
    <div class="text-base opacity-80 mt-1">Node.js と XRift CLI をインストールして、自分のプロジェクトを立ち上げます</div>
  </div>
</div>

<div class="flex items-start gap-5 p-4 rounded-xl bg-purple-500/10 border border-purple-400/30">
  <div class="text-purple-300 font-bold text-3xl w-12 text-center shrink-0">2</div>
  <div>
    <div class="font-bold text-purple-300 text-2xl">自分だけのワールドに仕立てる</div>
    <div class="text-base opacity-80 mt-1">テンプレートの色・位置・テクスチャを変えて、オリジナルの空間に仕上げます</div>
  </div>
</div>

<div class="flex items-start gap-5 p-4 rounded-xl bg-purple-500/10 border border-purple-400/30">
  <div class="text-purple-300 font-bold text-3xl w-12 text-center shrink-0">3</div>
  <div>
    <div class="font-bold text-purple-300 text-2xl">世界に向けて公開する</div>
    <div class="text-base opacity-80 mt-1">作ったワールドをインターネットにアップロードして、URL を友達にシェア</div>
  </div>
</div>
...
<div class="mt-5 p-3 rounded-lg bg-purple-500/10 border-l-4 border-purple-400 text-base">
  終わるころには「自分の URL」を持って帰れる、それがゴールです
</div>
...
<div>
  ...
  <div class="text-xs opacity-60 mt-1 text-center">code.visualstudio.com を開いてダウンロード</div>
</div>
...
```
  ...
  <div class="p-2 rounded-lg bg-purple-500/10 border-l-4 border-purple-400 text-sm">
    <span class="font-bold text-purple-300">v18.0.0 以上</span> が表示されれば成功
  </div>
</div>
...
<div class="space-y-3">
  <div class="p-4 rounded-xl bg-yellow-500/10 border border-yellow-400/30 text-base">
    ...
    <div class="text-sm"><b>https://xrift.net/</b> で無料作成できます</div>
  </div>
...
<div class="text-lg opacity-80 mt-1">
<span class="font-mono text-purple-300">docs.xrift.net</span> に全コンポーネントとサンプルコードが揃っています
</div>
...
<div class="p-5 rounded-xl bg-purple-500/10 border border-purple-400/30">
  ...
  <div class="mt-2 opacity-80">docs.xrift.net</div>
...
<div class="p-5 rounded-xl bg-purple-500/10 border border-purple-400/30">
  ...
  <div class="mt-2 opacity-80">github.com/WebXR-JP</div>
...
<div class="p-5 rounded-xl bg-purple-500/10 border border-purple-400/30">
  ...
  <div class="mt-2 opacity-80">r3f.docs.pmnd.rs</div>
